...
local VolverLabel = Instance.new("TextLabel")
VolverLabel.Size = UDim2.new(1, -20, 0, 30)
VolverLabel.Position = UDim2.new(0, 10, 0, 5)
VolverLabel.BackgroundTransparency = 1
VolverLabel.Text = "🎖️ AUTO VOLVER - EB"
VolverLabel.TextColor3 = Color3.fromRGB(200, 255, 200)
VolverLabel.TextSize = 16
VolverLabel.Font = Enum.Font.GothamBold
VolverLabel.TextXAlignment = Enum.TextXAlignment.Left
VolverLabel.Parent = VolverFrame

-- Label Comandante
local CommanderLabel = Instance.new("TextLabel")
CommanderLabel.Size = UDim2.new(1, -20, 0, 32)
CommanderLabel.Position = UDim2.new(0, 10, 0, 40)
CommanderLabel.BackgroundColor3 = Color3.fromRGB(30, 60, 30)
...
ListLabel.Position = UDim2.new(0, 10, 0, 80)
ListLabel.BackgroundTransparency = 1
ListLabel.Text = "📋 SELECIONE UM COMANDANTE:"
ListLabel.TextColor3 = Color3.fromRGB(200, 200, 200)
ListLabel.TextSize = 12
ListLabel.Font = Enum.Font.GothamBold
ListLabel.TextXAlignment = Enum.TextXAlignment.Left
ListLabel.Parent = VolverFrame

-- Lista de Jogadores
local PlayerListFrame = Instance.new("ScrollingFrame")
PlayerListFrame.Size = UDim2.new(1, -20, 0, 180)
PlayerListFrame.Position = UDim2.new(0, 10, 0, 108)
PlayerListFrame.BackgroundColor3 = Color3.fromRGB(20, 30, 20)
PlayerListFrame.BorderSizePixel = 0
PlayerListFrame.ScrollBarThickness = 6
PlayerListFrame.ScrollBarImageColor3 = Color3.fromRGB(60, 150, 60)
...
StatusLabel.Text = "⚠️ Selecione um comandante\npara começar"
